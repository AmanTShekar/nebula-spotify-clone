                ...
                <div className="flex items-center justify-around px-2 py-2">
                    {navItems.map((item) => (
                        <NavLink
                            ...
                            to={item.path}
                            className={({ isActive }) =>
                                `flex flex-col items-center gap-1.5 px-4 py-3 rounded-xl transition-all min-w-[72px] ${isActive
                    ...
                    <button
                        ...
                        className="flex flex-col items-center gap-1.5 px-4 py-3 rounded-xl text-gray-400 hover:text-white transition-all active:scale-95 min-w-[72px]"
                    >
